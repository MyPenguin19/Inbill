...
export default function ResultPage() {
  ...
  const baseCardClass =
    "audit-card bg-white rounded-2xl border border-gray-200 shadow-sm p-6 md:p-8 transition hover:shadow-md hover:-translate-y-[1px]";
      ...
      <div className="mx-auto max-w-[720px]">
        <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="audit-actions flex w-full flex-wrap items-center justify-end gap-3 sm:w-auto">
            {!PAYWALL_ENABLED ? (
              <div className="rounded-xl border border-gray-200 bg-white px-3 py-2 text-xs font-medium text-gray-500 shadow-sm">
        ...
        {report && analysisJson ? (
          <div className="space-y-10">
            <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm ring-1 ring-gray-200 md:p-8">
              <div className="rounded-2xl bg-gradient-to-br from-white to-gray-50 p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04)] md:p-8">
            ...
            <section className="space-y-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {analysisJson.issues.map((issue) => (
                      <div
                        key={issue.title}
                        className="flex gap-4 rounded-xl border border-gray-200 bg-white p-4 transition hover:bg-gray-50"
                      >
              ...
              <article className={baseCardClass}>
                <div className="space-y-6">
                  ...
                  <div className="rounded-xl border border-gray-200 bg-white p-6 text-sm leading-relaxed text-gray-800 shadow-inner whitespace-pre-line">
                    {formalLetter.split("\n").map((line, index) => (
