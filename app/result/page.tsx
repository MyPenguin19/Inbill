...
export default function ResultPage() {
  ...
  const primaryButtonClass =
    "audit-button w-full rounded-xl bg-black px-4 py-3 text-sm font-semibold text-white transition-all duration-150 ease-out hover:opacity-90 active:scale-[0.99] disabled:opacity-70 disabled:cursor-wait";
  const secondaryButtonClass =
    "audit-button w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 transition-all duration-150 ease-out hover:bg-gray-100 active:scale-[0.99]";
  const utilityButtonClass =
    "audit-button rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 transition-all duration-150 ease-out hover:bg-gray-100";
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="mx-auto w-full max-w-[1200px] space-y-10 px-6 py-12">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-2">
            <div className="text-xl font-semibold tracking-tight text-gray-950">BillFixa</div>
            <div className="text-sm font-medium text-gray-500">Generated by BillFixa.com</div>
          </div>
        ...
        {report && analysisJson ? (
          <div className="space-y-10">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <p className="max-w-[60ch] text-sm font-medium leading-relaxed text-gray-700">{quickVerdict}</p>
                    <p className="text-sm font-semibold leading-relaxed text-red-700">
                      Do not pay this bill before reviewing the issues below.
                    </p>
                    <p className="max-w-[60ch] text-sm leading-relaxed text-gray-500">
            ...
            <section className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[1.3fr_0.7fr]">
              <div className="space-y-10">
              ...
              <article className={baseCardClass}>
                <div className="space-y-4">
                  ...
                  <p className="max-w-[60ch] text-sm leading-relaxed text-gray-600">{meaningText}</p>
                </div>
              </article>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-xl border border-blue-100 bg-blue-50 p-5">
                    {splitScript(detailedScript).map((line) => (
                      <p
                        key={line}
                        className="mb-3 max-w-[60ch] text-sm leading-relaxed text-gray-800 last:mb-0"
                      >
                        {line}
                      </p>
                    ))}
                  </div>
                  <div className="max-w-[60ch] text-sm leading-relaxed text-gray-500">Tip: Have your bill in front of you when calling.</div>
                </div>
              </article>
