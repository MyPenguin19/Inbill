        ...
        {report && analysisJson ? (
          <div className="space-y-10">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex flex-wrap items-start justify-between gap-6">
                    <div className="space-y-4 rounded-xl border border-green-100 bg-green-50 p-4">
                      <div>
            ...
            <section className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[1.3fr_0.7fr]">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="rounded-xl border border-gray-200 bg-white p-4">
                      ...
                      <p className="mt-2 max-w-[36ch] text-sm leading-relaxed text-gray-600">
                    ...
                    <div className="rounded-xl border border-blue-100 bg-blue-50 p-5">
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="mt-2 max-w-[60ch] text-sm leading-relaxed text-gray-800">
              ...
              <article className={baseCardClass}>
                <div className="space-y-6">
                  <h2 className="mb-4 text-lg font-semibold tracking-tight text-gray-950">Possible Outcomes</h2>
                  <div className="space-y-2">
              ...
              <article className={baseCardClass}>
                <div className="space-y-6">
                  <h2 className="mb-4 text-lg font-semibold tracking-tight text-gray-950">Save or Share</h2>
                  <p className="max-w-[60ch] text-sm leading-relaxed text-gray-600">
                    Save this report for follow-up or share the summary with someone helping you review the bill.
                  </p>
