...
const DISPUTE_LETTER_PDF_ID = "pdf-content";
...
export default function ResultPage() {
  ...
  async function handleDownloadLetterPdf() {
    ...
    try {
      ...
      if (!element) {
        window.alert("PDF content not ready");
        return;
      }
      ...
      await html2pdf()
        .set({
          margin: 0.5,
          filename: "billfixa-dispute-letter.pdf",
        ...
        {report && analysisJson ? (
          <div className="space-y-10">
            ...
            <section className="grid grid-cols-1 gap-8 lg:grid-cols-[1.3fr_0.7fr]">
              <article className={`${baseCardClass} order-1 lg:col-start-1`}>
              ...
              <article className={`${baseCardClass} order-2 lg:col-start-1`}>
                <div className="space-y-4">
              ...
              <article className={`${baseCardClass} order-5 lg:col-start-1`}>
                <div className="space-y-6">
                      ...
                      <div key={step} className="grid grid-cols-[28px_minmax(0,1fr)] gap-4 border-t border-gray-200 pt-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="text-sm leading-relaxed text-gray-600">
                            {index === 0
                              ? "Call before making payment and ask them to review the charges on your account."
                              : index === 1
                                ? "Ask for a line-by-line breakdown of each charge listed on the bill."
                                : index === 2
                                  ? "Reference the issues identified in this report and request verification of each one."
                                  : "Ask them to send an updated corrected statement after the review is complete."}
                          </div>
                        </div>
                      </div>
                    ))}
              ...
              <article className={`${baseCardClass} order-3 lg:col-start-2 lg:row-start-1`}>
                <div className="space-y-6">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div className="space-y-1">
              ...
              <article className={`${baseCardClass} order-4 lg:col-start-2 lg:row-start-2`}>
                <div className="space-y-6">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div className="space-y-1">
                  ...
                  <div
                    ...
                    className="rounded-xl border border-gray-200 bg-white p-8 text-black shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)]"
                  >
                    <div className="mb-6 border-b border-gray-200 pb-4">
                      <div className="text-xl font-semibold tracking-tight text-gray-950">
                        Medical Bill Dispute Letter
                      </div>
                      <div className="mt-1 text-sm text-gray-500">Generated by BillFixa.com</div>
                    </div>

                    <div className="space-y-3 whitespace-pre-line text-sm leading-relaxed text-gray-800">
                      {formalLetter.split("\n").map((line, index) => (
              ...
              <article className={`${baseCardClass} order-6 lg:col-start-2 lg:row-start-3`}>
                <div className="space-y-4">
                  <h2 className="text-lg font-semibold tracking-tight text-gray-950">Quick Actions</h2>
              ...
              {!isPaid ? (
                <article className={`${baseCardClass} order-7 lg:col-start-2 lg:row-start-4`}>
                  <div className="space-y-4">
            ...
            <footer className="flex flex-wrap items-center justify-between gap-3 pb-2 text-xs font-medium text-gray-500">
              <div>Billing errors are often resolved before payment, not after.</div>
